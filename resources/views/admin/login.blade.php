...
<head>
  ...
  <title>Dopadox Admin | Log in</title>
  ...
  <!-- iCheck -->
  <link rel="stylesheet" href="{{ asset("public/admin_lte/plugins/iCheck/square/blue.css") }}">
...
<style type="text/css">
  .back-img{
background: url({{ asset("public/images/bg-2.jpg") }}) center center no-repeat fixed;
  }
  /*.jj{
    background: url(../public/images/bg-2.jpg) center center no-repeat fixed;
  }*/
</style>
</head>
<body class="hold-transition login-page back-img" >
  <div class="login-box">
    <div class="login-logo">
      ...
      @else
        <a href="{{url('/')}}"><b>Admin</b>Dopadox</a>
      @endif
    </div>
    <!-- /.login-logo -->
  ...
  <!-- iCheck -->
  <script src="{{ asset("public/admin_lte/plugins/iCheck/icheck.min.js") }}"></script>
  <script>
    $(function () {
      $('input').iCheck({
