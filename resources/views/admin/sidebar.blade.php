...
<li class="nav-item">
    ...
    <li class="nav-item has-treeview <?php  if(request()->is('admin/setting')|| request()->is('admin/footer-details') ){ echo 'menu-open';}?>">
      <a href="#" class="nav-link">
      ...
      <ul class="nav nav-treeview">
        <li class="nav-item">
         ...
         <li class="nav-item">
          <a href="{{ url('admin/footer-details') }}" class="nav-link {{ request()->is('admin/footer-details') ? 'active' : '' }}">
            <i class="far fa-circle nav-icon"></i>
            <p>Footer Details</p>
          </a>
        </li>
